        ...
        <div className="flex justify-between mt-8">
          <div className="grid grid-cols-3 gap-12">
            <div>
              ...
              <ul className="text-white font-medium text-lg">
                <li className="hover:text-yellow hover:cursor-pointer">
                  Our Customer
                </li>
                <li className="hover:text-yellow hover:cursor-pointer">Legal</li>
              </ul>
            </div>
            <div>
          ...
          <div>
            ...
            <div className="flex justify-evenly">
              <span className="bg-yellow hover:bg-white text-white hover:text-primary cursor-pointer p-2 rounded-sm">
